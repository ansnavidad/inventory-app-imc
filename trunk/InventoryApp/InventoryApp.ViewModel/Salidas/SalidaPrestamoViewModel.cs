    ...
    public class SalidaPrestamoViewModel : IPageViewModel, INotifyPropertyChanged
    {
        ...
        public void AttempImprimir()
        {
            ...
            if (dlg.ShowDialog() == true)
            {
                ...
                Workbook excelPrint = excel.Workbooks.Open(@"C:\temp\elarainventarios\SalidaPrestamo.xlsx", Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value);
