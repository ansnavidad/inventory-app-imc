...
{
    public class ReadOnlySalidaBajaViewModel
    {
        #region Fields
        ...
        public ReadOnlySalidaBajaViewModel(MovimientoModel selectedMovimientoModel)
        {
            ...
            this._movimientoModel.Observaciones = movLectura.Observaciones;
            //carga el grid
        ...
        public ReadOnlySalidaBajaViewModel() { }
        #endregion
        ...
        public void AttempImprimir()
        {
            ...
            if (dlg.ShowDialog() == true)
            {
                ...
                try
                {
                    ...
                    excel.Cells[X, 9] = _movimientoModel.Observaciones;
