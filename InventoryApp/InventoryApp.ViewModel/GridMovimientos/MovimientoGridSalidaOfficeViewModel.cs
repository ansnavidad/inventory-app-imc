...
{
    public class MovimientoGridSalidaOfficeViewModel: IPageViewModel
    {
        ...
        public MovimientoGridSalidaOfficeViewModel()
        {
            try
            {
        ...
        public MovimientoGridSalidaOfficeViewModel(string readOnly)
        {
        ...
        public ReadOnlySalidaOfficeViewModel CreateReadOnlySalidaOfficeViewModel()
        {
            ...
            return new ReadOnlySalidaOfficeViewModel(movimientoModel);
        }
        ...
        {
            this.CatalogMovimientoModel.loadItemsSalidaOffice();
        }
