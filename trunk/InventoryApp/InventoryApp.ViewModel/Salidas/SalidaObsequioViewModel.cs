...
{
    public class SalidaObsequioViewModel : IPageViewModel, INotifyPropertyChanged
    {
        ...
        private MovimientoGridSalidaObsequioViewModel _movimientoSalida;
        ...
        public void AttempImprimir()
        {
            ...
            if (dlg.ShowDialog() == true)
            {
                ...
                Workbook excelPrint = excel.Workbooks.Open(@"C:\temp\elarainventarios\SalidaObsequio.xlsx", Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value);
