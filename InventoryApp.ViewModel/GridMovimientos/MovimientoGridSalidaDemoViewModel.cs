...
namespace InventoryApp.ViewModel.GridMovimientos
{
    public class MovimientoGridSalidaDemoViewModel: IPageViewModel
    {
        ...
        public MovimientoGridSalidaDemoViewModel(USUARIO u)
        {
            try
            {
                ...
                this._catalogMovimientoModel = new CatalogMovimientoModel(new MovimientoDataMapper(), "Salida Demo");
        ...
        public MovimientoGridSalidaDemoViewModel(string readOnly)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public ReadOnlySalidaDemoViewModel CreateReadOnlySalidaDemoViewModel()
        {
            ...
            return new ReadOnlySalidaDemoViewModel(movimientoModel, this.ActualUser);
        }
