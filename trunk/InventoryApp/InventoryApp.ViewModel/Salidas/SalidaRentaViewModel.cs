...
{
    public class SalidaRentaViewModel : IPageViewModel, INotifyPropertyChanged
    {
        ...
        private MovimientoGridSalidaRentaViewModel _movimientoSalida;
        ...
        public SalidaRentaViewModel(MovimientoGridSalidaRentaViewModel salida)
        {
            try
            {
                IDataMapper dataMapper = new SolicitanteDataMapper();
        ...
        public void AttempImprimir()
        {
            ...
            if (dlg.ShowDialog() == true)
            {
                ...
                Workbook excelPrint = excel.Workbooks.Open(@"C:\Programs\ElaraInventario\Resources\SalidaRenta.xlsx", Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value);
