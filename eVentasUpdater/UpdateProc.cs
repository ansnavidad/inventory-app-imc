...
namespace eVentasUpdater
{
    class UpdateProc
    {
        ...
        public void downloadServerFiles()
        {
            ...
            {
                this.addStatusTextBoxLine("No se pudieron descargar los archivos. Compruebe que cuenta con conexión y vuelva a intentar mas tarde");
            }
        }/////////////////////////////////////////////////////
        ...
        public string[] getServerFileLists()
        {
            ...
            {
                this.addStatusTextBoxLine("No pudo conectar a la carpeta " + AppConfs.updateFilesFolder + ". Valide que tenga los permisos necesarios para ejecutar esta tarea.");
                throw ex;
            }
            return arr;
        }///////////////////////////////////////////////////////
        ...
        public void createUserFolder()
        {
            ...
            {
                this.addStatusTextBoxLine("No pudo crear la carpeta de usuario; valide que haya ingresado con el usuario que hace uso de la aplicación. " + ex.Message);
                throw ex;
            }
        }///////////////////////////////////////////////////////
