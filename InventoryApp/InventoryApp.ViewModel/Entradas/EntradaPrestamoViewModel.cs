    ...
    public class EntradaPrestamoViewModel : IPageViewModel
    {
        ...
        public void AttempImprimir()
        {
            ...
            if (dlg.ShowDialog() == true)
            {
                ...
                Workbook excelPrint = excel.Workbooks.Open(@"C:\temp\elarainventarios\EntradaPrestamo.xlsx", Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value);
