...
{
    public class SalidaCorrectivoViewModel : IPageViewModel, INotifyPropertyChanged
    {
        ...
        private MovimientoGridSalidaCorrectivoViewModel _movimientoSalida;
        private RelayCommand _addItemCommand;
        private RelayCommand _deleteItemCommand;
        private RelayCommand _imprimirCommand;

        public SalidaCorrectivoViewModel()
        {            
            try
            {
