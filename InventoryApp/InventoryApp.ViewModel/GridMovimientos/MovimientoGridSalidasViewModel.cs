...
{
    public class MovimientoGridSalidasViewModel : IPageViewModel
    {
        ...
        public MovimientoGridSalidasViewModel()
        {
            try
            {
                ...
                this._catalogMovimientoModel = new CatalogMovimientoModel(new MovimientoDataMapper(), "Rafa", "oppan gangnam style");
        ...
        string IPageViewModel.PageName
        {
            get
            {
                throw new NotImplementedException();
