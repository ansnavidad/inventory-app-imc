    ...
    public class MovimientoDetalleModel : INotifyPropertyChanged
    {
        ...
        public void saveArticulo()
        {
            if (_dataMapper != null)
            {
                ...
                _dataMapper.insertElement(new MOVIMIENTO_DETALLE() {UNID_MOVIMIENTO_DETALLE = this._unidMovimientoDetalle, UNID_MOVIMIENTO = this.UnidMovimiento, UNID_ITEM = this._unidItem, IS_ACTIVE = this._isActive });
