...
{
    public class SalidaPruebasViewModel : IPageViewModel, INotifyPropertyChanged
    {
        ...
        private MovimientoGridSalidaPruebasViewModel _movimientoSalida;
        ...
        public SalidaPruebasViewModel(MovimientoGridSalidaPruebasViewModel salida)
        {
            try
            {
                IDataMapper dataMapper = new SolicitanteDataMapper();
        ...
        public void AttempImprimir()
        {
            ...
            if (dlg.ShowDialog() == true)
            {
                ...
                Workbook excelPrint = excel.Workbooks.Open(@"C:\temp\elarainventarios\SalidaPruebas.xlsx", Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value);
