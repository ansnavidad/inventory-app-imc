...
namespace InventoryApp.DAL.POCOS
{
    public partial class ULTIMO_MOVIMIENTO
    {
        ...
        public virtual long UNID_ULTIMO_MOVIMIENTO
        {
            get;
            set;
        }
        ...
        private void FixupITEM(ITEM previousValue)
        {
            ...
            if (ITEM != null)
            {
                if (!ITEM.ULTIMO_MOVIMIENTO.Contains(this))
                {
                    ITEM.ULTIMO_MOVIMIENTO.Add(this);
                }
        ...
        private void FixupMASTER_INVENTARIOS(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.ULTIMO_MOVIMIENTO, this))
                    {
                        item.ULTIMO_MOVIMIENTO = null;
                    }
                }
            }
        }
        ...
        private void FixupMASTER_INVENTARIOS1(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                foreach (MASTER_INVENTARIOS item in e.OldItems)
                {
                    if (ReferenceEquals(item.ULTIMO_MOVIMIENTO1, this))
                    {
                        item.ULTIMO_MOVIMIENTO1 = null;
                    }
                }
            }
        }
