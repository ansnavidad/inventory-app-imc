...
{
    public class SalidaPrestamoViewModel : IPageViewModel, INotifyPropertyChanged
    {
        ...
        private MovimientoGridSalidaPrestamoViewModel _movimientoSalida;
        ...
        public SalidaPrestamoViewModel(MovimientoGridSalidaPrestamoViewModel salida)
        {
            try
            {
                IDataMapper dataMapper = new SolicitanteDataMapper();
        ...
        public void AttempImprimir()
        {
            ...
            if (dlg.ShowDialog() == true)
            {
                ...
                Workbook excelPrint = excel.Workbooks.Open(@"C:\Programs\ElaraInventario\Resources\SalidaPrestamo.xlsx", Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value);
