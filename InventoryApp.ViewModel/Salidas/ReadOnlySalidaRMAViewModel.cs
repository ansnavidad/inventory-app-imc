...
{
    public class ReadOnlySalidaRMAViewModel
    {
        #region Fields
        ...
        public ReadOnlySalidaRMAViewModel(MovimientoModel selectedMovimientoModel, USUARIO u)
        {
        ...
        public ReadOnlySalidaRMAViewModel() { }
        #endregion
        ...
        public void AttempImprimir()
        {
            ...
            if (dlg.ShowDialog() == true)
            {
                ...
                Workbook excelPrint = excel.Workbooks.Open(@"C:\Programs\ElaraInventario\Resources\SalidaRMA.xlsx", Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value);
