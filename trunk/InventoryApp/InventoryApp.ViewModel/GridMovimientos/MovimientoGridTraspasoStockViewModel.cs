...
{
    public class MovimientoGridTraspasoStockViewModel : IPageViewModel
    {
        ...
        public MovimientoGridTraspasoStockViewModel(USUARIO u)
        {
            try
            {
                ...
                this._catalogMovimientoModel = new CatalogMovimientoModel(new MovimientoDataMapper(), 20);
        ...
        public ReadOnlyTraspasoStockViewModel CreateReadOnlyTraspasoStockViewModel()
        {
            ...
            return new ReadOnlyTraspasoStockViewModel(/*this,*/ movimientoModel, this.ActualUser);
        }
        ...
        {
            this.CatalogMovimientoModel.loadItemsTraspaso();
        }
