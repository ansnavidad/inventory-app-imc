    ...
    public class MovimientoGridEntradasViewModel : IPageViewModel
    {
        ...
        public MovimientoGridEntradasViewModel()
        {
            try
            {
                ...
                this._catalogMovimientoModel = new CatalogMovimientoModel(new MovimientoDataMapper(), "Entrada Validación/Entrada");
        ...
        public MovimientoGridEntradasViewModel(string readOnly)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public ReadOnlyEntradaPorValidaionViewModel CreateReadOnlyEntradaPorValidacionViewModel()
        {
            ...
            if (this._catalogMovimientoModel != null && this._catalogMovimientoModel.SelectedMovimientoGrid != null)
            {
                ...
                movimientoModel.AlmacenProcedencia = this._catalogMovimientoModel.SelectedMovimientoGrid.AlmacenProcedencia;
            ...
            return new ReadOnlyEntradaPorValidaionViewModel(this, movimientoModel);
        }
        ...
        public void loadItems()
        {
            ...
            this._catalogMovimientoModel.loadItemsEntradaValidacion();
        }

        public void updateItems()
        {
            this.CatalogMovimientoModel.loadItemsEntradaValidacion();
        }
