...
namespace InventoryApp.DAL.POCOS
{
    public partial class TAE2Entities : ObjectContext
    {
        ...
        {
            get { return _iNVENTARIOs  ?? (_iNVENTARIOs = CreateObjectSet<INVENTARIO>("INVENTARIOs")); }
        }
        private ObjectSet<INVENTARIO> _iNVENTARIOs;
    
        public ObjectSet<LOGIN_LAST_USER> LOGIN_LAST_USER
        {
            get { return _lOGIN_LAST_USER  ?? (_lOGIN_LAST_USER = CreateObjectSet<LOGIN_LAST_USER>("LOGIN_LAST_USER")); }
        }
        private ObjectSet<LOGIN_LAST_USER> _lOGIN_LAST_USER;
        ...
        public void GetJob()
        {
            base.ExecuteFunction<TEST>("SP_TAE2_JOB");
        }
        #endregion
    }
}
