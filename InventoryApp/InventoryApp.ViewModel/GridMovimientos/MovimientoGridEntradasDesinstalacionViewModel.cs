...
{
    public class MovimientoGridEntradasDesinstalacionViewModel : IPageViewModel
    {
        ...
        public MovimientoGridEntradasDesinstalacionViewModel()
        {
            try
            {
                ...
                this._catalogMovimientoModel = new CatalogMovimientoModel(new MovimientoDataMapper(), "Entrada Desinstalacion");
        ...
        public MovimientoGridEntradasDesinstalacionViewModel(string readOnly)
        {
        ...
        public ReadOnlyEntradaDesistalacionViewModel CreateReadOnlyEntradaDesistalacionViewModel()
        {
            ...
            return new ReadOnlyEntradaDesistalacionViewModel(this, movimientoModel);
        }
        ...
        {
            this.CatalogMovimientoModel.loadItemsEntradaDesinstalacion();
        }
