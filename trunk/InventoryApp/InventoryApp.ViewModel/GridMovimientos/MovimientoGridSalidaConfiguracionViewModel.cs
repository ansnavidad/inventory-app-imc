...
{
    public class MovimientoGridSalidaConfiguracionViewModel: IPageViewModel
    {
        ...
        public MovimientoGridSalidaConfiguracionViewModel(USUARIO u)
        {
            try
            {
                ...
                this._catalogMovimientoModel = new CatalogMovimientoModel(new MovimientoDataMapper(), "Salida Configuración");
        ...
        public MovimientoGridSalidaConfiguracionViewModel(string readOnly)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public ReadOnlySalidaConfiguracionViewModel CreateReadOnlySalidaConfiguracionViewModel()
        {
            ...
            return new ReadOnlySalidaConfiguracionViewModel(movimientoModel, this.ActualUser);
        }
        ...
        {
            this.CatalogMovimientoModel.loadItemsSalidaConfiguracion();
        }
