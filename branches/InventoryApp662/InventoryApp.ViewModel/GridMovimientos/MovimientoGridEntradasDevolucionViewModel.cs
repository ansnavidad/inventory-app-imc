...
{
    public class MovimientoGridEntradasDevolucionViewModel : IPageViewModel
    {
        ...
        public MovimientoGridEntradasDevolucionViewModel(USUARIO u)
        {
            try
            {
                ...
                this._catalogMovimientoModel = new CatalogMovimientoModel(new MovimientoDataMapper(), "Entrada Devolucion");
        ...
        public ReadOnlyEntradaDevolucionViewModel CreateReadOnlyEntradaDevolucionViewModel()
        {
            ...
            return new ReadOnlyEntradaDevolucionViewModel(this, movimientoModel, this.ActualUser);
        }
        ...
        {
            this.CatalogMovimientoModel.loadItemsEntradaDevolucion();
        }
