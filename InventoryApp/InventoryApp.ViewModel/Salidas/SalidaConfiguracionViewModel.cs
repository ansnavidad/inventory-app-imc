...
{
    public class SalidaConfiguracionViewModel : IPageViewModel, INotifyPropertyChanged
    {
        ...
        public SalidaConfiguracionViewModel(MovimientoGridSalidaConfiguracionViewModel salida)
        {
            try
            {
                IDataMapper dataMapper = new SolicitanteDataMapper();
        ...
        public void AttempImprimir()
        {
            ...
            if (dlg.ShowDialog() == true)
            {
                ...
                Workbook excelPrint = excel.Workbooks.Open(@"C:\temp\elarainventarios\SalidaConfiguracion.xlsx", Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value);
