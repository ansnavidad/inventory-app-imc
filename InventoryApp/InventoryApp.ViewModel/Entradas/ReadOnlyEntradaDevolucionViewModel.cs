...
{
    public class ReadOnlyEntradaDevolucionViewModel : ViewModelBase, IPageViewModel, INotifyPropertyChanged
    {
        #region Fields
        ...
        public bool CanAttempImprimir()
        {
            ...
            //if (this.ItemModel.ItemModel.Count() != 0 && !String.IsNullOrEmpty(this.MovimientoModel.Contacto) && !String.IsNullOrEmpty(this.MovimientoModel.Tt) && !String.IsNullOrEmpty(this.MovimientoModel.Guia))
                //_canImprimir = true;
