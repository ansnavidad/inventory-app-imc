...
{
    public class ReadOnlySalidaCorrectivoViewModel
    {
        #region Fields
        ...
        public ReadOnlySalidaCorrectivoViewModel(MovimientoModel selectedMovimientoModel, USUARIO u)
        {
        ...
        public ReadOnlySalidaCorrectivoViewModel() { }
        #endregion
        ...
        public void AttempImprimir()
        {
            ...
            if (dlg.ShowDialog() == true)
            {
                ...
                Workbook excelPrint = excel.Workbooks.Open(@"C:\Programs\ElaraInventario\Resources\SalidaCorrectivo.xlsx", Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value);
                ...
                try
                {
                    ...
                    //Procedencia                
                    excel.Cells[17, 12] = _movimientoModel.AlmacenProcedenciaLectura.ALMACEN_NAME;
                    //Destino
                    string p = "";
                ...
                //Contacto
                excel.Cells[31, 12] = _movimientoModel.Contacto;
                //Guia
                excel.Cells[29, 12] = _movimientoModel.Guia;
                //Nombre de Sitio
                excel.Cells[23, 12] = _movimientoModel.NombreSitio;
                //Sitio/Enlace
                excel.Cells[25, 12] = _movimientoModel.SitioEnlace;
