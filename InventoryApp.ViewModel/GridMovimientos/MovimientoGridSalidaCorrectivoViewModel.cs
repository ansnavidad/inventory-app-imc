...
{
    public class MovimientoGridSalidaCorrectivoViewModel: IPageViewModel
    {
        ...
        public MovimientoGridSalidaCorrectivoViewModel(USUARIO u)
        {
            try
            {
                ...
                this._catalogMovimientoModel = new CatalogMovimientoModel(new MovimientoDataMapper(), "Salida Correctivo");
        ...
        public ReadOnlySalidaCorrectivoViewModel CreateReadOnlySalidaCorrectivoViewModel()
        {
            ...
            return new ReadOnlySalidaCorrectivoViewModel(movimientoModel, this.ActualUser);
        }
        ...
        {
            this.CatalogMovimientoModel.loadItemsSalidaCorrectivo();
        }
