...
namespace eVentasUpdater
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void btnCancelar_Click(object sender, RoutedEventArgs e)
        {
            if (!upFail)
            {
                MessageBoxResult res = System.Windows.MessageBox.Show(this, "¿Desea interrumpir el proceso de actualización?", "Elara Updater", MessageBoxButton.YesNo, MessageBoxImage.Warning, MessageBoxResult.No, MessageBoxOptions.None);
        ...
        private void btnTerminar_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                this.addStatusTextBoxLine("*** No se pudo iniciar el proceso de Elara..." + ex.Message);
            }
            Application.Current.Shutdown();
        }//////////////////////////////////////////////////////////
