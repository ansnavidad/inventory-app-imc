...
{
    public class MovimientoGridSalidaVentaViewModel : IPageViewModel
    {
        ...
        public MovimientoGridSalidaVentaViewModel(USUARIO u)
        {
            try
            {
                ...
                this._catalogMovimientoModel = new CatalogMovimientoModel(new MovimientoDataMapper(), "Salida Venta");
        ...
        public MovimientoGridSalidaVentaViewModel(string readOnly)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public ReadOnlySalidaVentaViewModel CreateReadOnlySalidaVentaViewModel()
        {
            ...
            return new ReadOnlySalidaVentaViewModel(movimientoModel, this.ActualUser);
        }
        ...
        {
            this.CatalogMovimientoModel.loadItemsSalidaVenta();
        }
