...
{
    public class ReadOnlySalidaOfficeViewModel
    {
        #region Fields
        ...
        public ReadOnlySalidaOfficeViewModel(MovimientoModel selectedMovimientoModel, USUARIO u)
        {
            this._movimientoModel = new MovimientoModel(new MovimientoDataMapper(), u);
        ...
        public ReadOnlySalidaOfficeViewModel() { }
        #endregion
        ...
        public bool CanAttempImprimir()
        {
            ...
            //if (this.ItemModel.ItemModel.Count() != 0 && !String.IsNullOrEmpty(this.MovimientoModel.Contacto) && !String.IsNullOrEmpty(this.MovimientoModel.Tt))
            //    _canImprimir = true;
        ...
        public void AttempImprimir()
        {
            ...
            if (dlg.ShowDialog() == true)
            {
                ...
                //Contacto
                excel.Cells[25, 12] = _movimientoModel.Contacto;
