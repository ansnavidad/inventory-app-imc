...
{
    public class MovimientoGridSalidaRentaViewModel: IPageViewModel
    {
        ...
        public MovimientoGridSalidaRentaViewModel(USUARIO u)
        {
            try
            {
                ...
                this._catalogMovimientoModel = new CatalogMovimientoModel(new MovimientoDataMapper(), "Salida Renta");
        ...
        public MovimientoGridSalidaRentaViewModel(string readOnly)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public ReadOnlySalidaRentaViewModel CreateReadOnlySalidaRentaViewModel()
        {
            ...
            return new ReadOnlySalidaRentaViewModel(movimientoModel, this.ActualUser);
        }
        ...
        {
            this.CatalogMovimientoModel.loadItemsSalidaRenta();
        }
