...
{
    public class MovimientoGridSalidaPrestamoViewModel: IPageViewModel
    {
        ...
        public MovimientoGridSalidaPrestamoViewModel(USUARIO u)
        {
            try
            {
                ...
                this._catalogMovimientoModel = new CatalogMovimientoModel(new MovimientoDataMapper(), "Salida Prestamo");
        ...
        public MovimientoGridSalidaPrestamoViewModel(string readOnly)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public ReadOnlySalidaPrestamoViewModel CreateReadOnlySalidaPrestamoViewModel()
        {
            ...
            return new ReadOnlySalidaPrestamoViewModel(movimientoModel, this.ActualUser);
        }
