...
namespace InventoryApp.ViewModel.GridMovimientos
{
    public class MovimientoGridEntradasPrestamoViewModel : IPageViewModel
    {
        ...
        public MovimientoGridEntradasPrestamoViewModel(USUARIO u)
        {
            try
            {
                ...
                this._catalogMovimientoModel = new CatalogMovimientoModel(new MovimientoDataMapper(), "Entrada Prestamo");
        ...
        public MovimientoGridEntradasPrestamoViewModel(string readOnly)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public ReadOnlyEntradaPrestamoViewModel CreateReadOnlyEntradaPrestamoViewModel()
        {
            ...
            return new ReadOnlyEntradaPrestamoViewModel(this, movimientoModel, this.ActualUser);
        }
        ...
        {
            this.CatalogMovimientoModel.loadItemsEntradaPrestamo();
        }
