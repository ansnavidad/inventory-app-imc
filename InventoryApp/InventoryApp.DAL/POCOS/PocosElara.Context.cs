...
namespace InventoryApp.DAL.POCOS
{
    public partial class TAE2Entities : ObjectContext
    {
        ...
        public ObjectSet<BATCH_LOAD_CARGAMVTOS> BATCH_LOAD_CARGAMVTOS
        {
            get { return _bATCH_LOAD_CARGAMVTOS  ?? (_bATCH_LOAD_CARGAMVTOS = CreateObjectSet<BATCH_LOAD_CARGAMVTOS>("BATCH_LOAD_CARGAMVTOS")); }
        }
        private ObjectSet<BATCH_LOAD_CARGAMVTOS> _bATCH_LOAD_CARGAMVTOS;
    
        public ObjectSet<LOG_LOAD_CARGAMVTOS> LOG_LOAD_CARGAMVTOS
        {
            get { return _lOG_LOAD_CARGAMVTOS  ?? (_lOG_LOAD_CARGAMVTOS = CreateObjectSet<LOG_LOAD_CARGAMVTOS>("LOG_LOAD_CARGAMVTOS")); }
        }
        private ObjectSet<LOG_LOAD_CARGAMVTOS> _lOG_LOAD_CARGAMVTOS;
    
        public ObjectSet<STG_FACTURA> STG_FACTURA
        {
            get { return _sTG_FACTURA  ?? (_sTG_FACTURA = CreateObjectSet<STG_FACTURA>("STG_FACTURA")); }
        }
        private ObjectSet<STG_FACTURA> _sTG_FACTURA;
    
        public ObjectSet<STG_FACTURA_DETALLE> STG_FACTURA_DETALLE
        {
            get { return _sTG_FACTURA_DETALLE  ?? (_sTG_FACTURA_DETALLE = CreateObjectSet<STG_FACTURA_DETALLE>("STG_FACTURA_DETALLE")); }
        }
        private ObjectSet<STG_FACTURA_DETALLE> _sTG_FACTURA_DETALLE;
    
        public ObjectSet<STG_ITEM> STG_ITEM
        {
            get { return _sTG_ITEM  ?? (_sTG_ITEM = CreateObjectSet<STG_ITEM>("STG_ITEM")); }
        }
        private ObjectSet<STG_ITEM> _sTG_ITEM;
    
        public ObjectSet<STG_MOVIMIENTO> STG_MOVIMIENTO
        {
            get { return _sTG_MOVIMIENTO  ?? (_sTG_MOVIMIENTO = CreateObjectSet<STG_MOVIMIENTO>("STG_MOVIMIENTO")); }
        }
        private ObjectSet<STG_MOVIMIENTO> _sTG_MOVIMIENTO;
