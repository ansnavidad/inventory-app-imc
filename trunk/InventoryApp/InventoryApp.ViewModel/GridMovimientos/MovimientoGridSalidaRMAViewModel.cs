...
{
    public class MovimientoGridSalidaRMAViewModel : IPageViewModel
    {
        ...
        public MovimientoGridSalidaRMAViewModel(USUARIO u)
        {
            try
            {
                ...
                this._catalogMovimientoModel = new CatalogMovimientoModel(new MovimientoDataMapper(), "Salida RMA");
        ...
        public MovimientoGridSalidaRMAViewModel(string readOnly)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public ReadOnlySalidaRMAViewModel CreateReadOnlySalidaRMAViewModel()
        {
            ...
            return new ReadOnlySalidaRMAViewModel(movimientoModel, this.ActualUser);
        }
        ...
        {
            this.CatalogMovimientoModel.loadItemsSalidaRMA();
        }
