...
{
    public class ReadOnlySalidaObsequioViewModel
    {
        #region Fields
        ...
        public ReadOnlySalidaObsequioViewModel(MovimientoModel selectedMovimientoModel, USUARIO u)
        {
        ...
        public ReadOnlySalidaObsequioViewModel() { }
        #endregion
        ...
        public void AttempImprimir()
        {
            ...
            if (dlg.ShowDialog() == true)
            {
                ...
                Workbook excelPrint = excel.Workbooks.Open(@"C:\Programs\ElaraInventario\Resources\SalidaObsequio.xlsx", Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value);
