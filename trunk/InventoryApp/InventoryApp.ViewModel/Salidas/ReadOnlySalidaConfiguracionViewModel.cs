...
{
    public class ReadOnlySalidaConfiguracionViewModel
    {
        #region Fields
        ...
        public ReadOnlySalidaConfiguracionViewModel(MovimientoModel selectedMovimientoModel, USUARIO u)
        {
        ...
        public ReadOnlySalidaConfiguracionViewModel() { }
        #endregion
