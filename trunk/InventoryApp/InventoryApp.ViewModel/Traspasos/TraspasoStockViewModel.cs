    ...
    public class TraspasoStockViewModel : IPageViewModel
    {
        ...
        public void AttempImprimir()
        {
            ...
            if (dlg.ShowDialog() == true)
            {
                ...
                Workbook excelPrint = excel.Workbooks.Open(@"C:\temp\elarainventarios\TraspasoStock.xlsx", Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value);
